...
const links = [['Dashboard','/dashboard'],['Products','/dashboard/products'],['Creative Studio','/dashboard/studio'],['Campaigns','/dashboard/campaigns'],['Analytics','/dashboard/analytics']];
